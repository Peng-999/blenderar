...
createCSSRule('.enter-AR-button', "cursor: pointer; position: absolute; z-index: 1; display: block; width: 200px; height: 50px; left: 50%; bottom: 20px; background-size: 100%; margin-left: -100px; background-color: rgba(255,255,255,0); outline: 0;", false, '');
addHTMLElement('a', 'enter_AR_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'enter-AR-button', 'enter_AR_button', false);
addHTMLElement('img', 'enter_AR_button.img', 'TO', 'enter_AR_button', false);
setHTMLElemAttribute('src', 'media/enter_AR_button.png', 'enter_AR_button.img', false);
...
addHTMLElement('img', 'warning_AR_unavailable.img', 'TO', 'warning_AR_unavailable', false);
setHTMLElemAttribute('src', 'media/warning_AR_unavailable.png', 'warning_AR_unavailable.img', false);
...
setHTMLElemAttribute('href', 'https://github.com/Peng-999', 'info_button', false);
...
operateAnimation('PLAY', 'peng_armature', 0, 250, 'LoopRepeat', 1,
        function() {}, false);


registerOnClick('peng_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'peng_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'peng_armature', 251, 350, 'LoopOnce', 1,
          function() {

    operateAnimation('PLAY', 'peng_armature', 1, 250, 'LoopRepeat', 1,
            function() {}, false);
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'peng_group'], false);
      ...
      changeVis(['GROUP', 'peng_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('peng_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('peng_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('peng_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'peng.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'peng_group'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('peng_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('peng_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('peng_armature', 'XY', 'WORLD', 'NCBx^ELzre=ZeXsMB:x3', 'N:de0`PA^4~Nn(d4=}fe');
}, function() {}, 'N:de0`PA^4~Nn(d4=}fe');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('peng_armature', 'Z', 'WORLD', 'sgn/SqYpz=F-+pb=9U]y', 't:$LQ;D9EM[:+)bD|xxH');
}, function() {}, 't:$LQ;D9EM[:+)bD|xxH');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('peng_armature', 'Z', '=i(}qC=/N7r79Z$Ai;@q', 'X,;T[H)F`6@+8YW^S2?}');
  dragScale('peng_armature', 'X', 'FJ=BC}n|4B]a6b61)t~V', 'X,;T[H)F`6@+8YW^S2?}');
  dragScale('peng_armature', 'Y', 'n5#aJmZV6t`$AOL:H:Md', 'X,;T[H)F`6@+8YW^S2?}');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('peng_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'X,;T[H)F`6@+8YW^S2?}');
